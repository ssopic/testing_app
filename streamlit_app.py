...
class SocialQRMaster:
    ...
    def _generate_single_image(self, payload, title, fill_color, back_color, width, height, app_address, logo_path, raw_export):
        ...
        title_font = get_font(int(avg_dim * 0.030), False)       # Increased from 0.045
        warning_font = get_font(int(avg_dim * 0.08), True)      # Increased from 0.08
        footer_font = get_font(int(avg_dim * 0.035), False)      # Increased from 0.035
